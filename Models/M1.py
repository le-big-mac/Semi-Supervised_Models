...
def hyperparameter_loop(dataset_name, dataloaders, input_size, num_classes, max_epochs, device):
    ...
    f = open('./results/{}/m1_{}_labelled_hyperparameter_train.csv'.format(dataset_name, num_labelled), 'ab')
    for p in param_combinations:
        ...
        model_path = './state/m1/{}_{}_{}_{}_{}'.format(dataset_name, num_labelled, h_v, h_c, z)
